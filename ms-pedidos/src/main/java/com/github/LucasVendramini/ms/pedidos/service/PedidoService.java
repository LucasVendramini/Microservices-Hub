...
import com.github.LucasVendramini.ms.pedidos.dto.ItemDoPedidoDTO;
...
import com.github.LucasVendramini.ms.pedidos.entities.Status;
import com.github.LucasVendramini.ms.pedidos.exceptions.ResourceNotFoundException;
import com.github.LucasVendramini.ms.pedidos.repositories.ItemDoPedidoRepository;
...
public class PedidoService {
    ...
    public PedidoDTO savePedido(PedidoDTO pedidoDTO) {
        ...
        mapDtoDoPedido(pedidoDTO, pedido);
        pedido.calcularValorTotalPedido();
        pedido = pedidoRepository.save(pedido);
        return new PedidoDTO(pedido);
    }

    private void mapDtoDoPedido(PedidoDTO pedidoDTO, Pedido pedido) {
